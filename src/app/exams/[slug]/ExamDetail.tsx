'use client'
// src/app/exams/[slug]/ExamDetail.tsx — Client component (only rendering, no data fetching)
import Link from 'next/link'
import { useState, useEffect } from 'react'   // use removed, useParams no longer needed
...
export default function ExamDetail({ exam, others }: { exam: Exam; others: Exam[] }) {
  // No useState for exam/others, no fetch useEffect
