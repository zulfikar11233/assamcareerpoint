...
export default function GovtJobsList({ initialJobs }: { initialJobs: Job[] }) {
  // ✅ Use initialJobs from server – no useEffect, no loading state
  const [jobs, setJobs] = useState<Job[]>(initialJobs.filter(j => j.status !== 'Draft'))
